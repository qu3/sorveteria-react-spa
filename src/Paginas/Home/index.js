        ...
        <div>
            ...
            <main>
                ...
                <section className='secao-conteudo'>
                    <img src='assets/banner-sabores.jpg' alt='Sabores' title='Sabores' />
                    <div className='secao-conteudo-texto'>
                ...
                <section className='secao-conteudo nossos-eventos-reverse' >
                    <div className='secao-conteudo-texto'>
                ...
                <section className='secao-conteudo'>
                    <img src='assets/sobre-image.jpg' alt='Sobre' title='Sobre' />
                    <div className='secao-conteudo-texto'>
                        <h2>SOBRE NÓS</h2>
